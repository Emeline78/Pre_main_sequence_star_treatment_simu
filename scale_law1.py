...
plt.errorbar(Ro_conv[mask],MS_rms[mask], yerr=MS_mean_dist[mask], fmt='o')
plt.xlabel("Convective Rossby")
plt.ylabel("MS mean")
plt.grid()
...
plt.figure()
plt.subplot(1,2,1)
plt.errorbar(Els[mask],MS_rms[mask], yerr=MS_mean_dist[mask], fmt='o')
plt.plot(x_plot, y_plot, color='red')
...
plt.figure()
plt.subplot(1,2,1)
plt.errorbar(Rm[mask],MS_rms[mask], yerr=MS_mean_dist[mask], fmt='o')
plt.plot(x_plot, y_plot, color='red')
