...
a_mean,b_mean,x_plot,y_plot = interp(Ro_conv[mask],MS_int[mask],MS_int_err[mask])
plt.figure()
plt.plot(x_plot, y_plot, color='red')
plt.errorbar(Ro_conv[mask],MS_int[mask], yerr=MS_int_err[mask], fmt='o')
plt.xlabel("Convective Rossby")
...
a_mean,b_mean,x_plot,y_plot = interp(Els[mask],MS_int[mask],MS_int_err[mask])
plt.figure()
plt.errorbar(Els[mask],MS_int[mask], yerr=MS_int_err[mask], fmt='o')
plt.plot(x_plot, y_plot, color='red')
plt.xlabel("Elsasser number")
plt.ylabel("MS integrated")
plt.grid()
...
a_mean,b_mean,x_plot,y_plot = interp(Rm[mask],MS_int[mask],MS_int_err[mask])
plt.figure()
plt.errorbar(Rm[mask],MS_int[mask], yerr=MS_int_err[mask], fmt='o')
plt.plot(x_plot, y_plot, color='red')
plt.xlabel("Reynolds magnetic")
plt.ylabel("MS integrated")
plt.grid()
