...
plt.figure()
plt.plot(x,christensen(x),label ="Christensen's law")
plt.plot(x,mine(x),label ="Law for my data")
plt.plot(x,mine_both(x),label ="Law for both data set")
plt.plot(x,schrinner(x),label ="Schrinner's law")
