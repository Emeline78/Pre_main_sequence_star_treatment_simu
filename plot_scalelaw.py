...
plt.figure()
plt.plot(x,christensen(x),label=r"Christensen : $0.92\,Ra_Q^{0.34}$")
plt.plot(x,mine(x),label=r"My law : $0.99\,Ra_Q^{0.31}$")
plt.plot(x,mine_both(x),label=r"My + Schrinner data : $1.34\,Ra_Q^{0.34}$")
plt.plot(x,schrinner(x),label=r"Schrinner : $1.58\,Ra_Q^{0.35}$")
